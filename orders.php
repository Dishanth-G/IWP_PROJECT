<?php
	...
	$query10="SELECT bookid,bookname,bprice,o.status1,o.shipping_address,imglink from book b,orders o where b.bookid=o.bookbid and o.user_name='$username'";
...
<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-nav-demo">
					...
					<li class="active"><a href="history.php"><i class="fa fa-list-alt"></i>&nbsp;My Orders</a></li>
...
<br>
	...
	<div id="content">
         ...
         while($rows10=mysqli_fetch_assoc($result10))
		{
			...
			if($rows10['imglink']=="bookuploads/")
			{
				echo'<img class="img" src="bookuploads\book.png">';
			}
			else
			{
				echo'<img class="img" src="'.$rows10['imglink'].'">';
			...
			<br>
			<label>Book id :&emsp;<?php echo $rows10['bookid'];?></label>
			<br>
			<label>Book name:&emsp;<?php echo $rows10['bookname'];?></label>
			<br>
			<label>Price:&emsp;<?php echo $rows10['bprice'];?></label>
			<br>
			...
			?>
			<label>Delivering to:&emsp;<?php echo $rows10['shipping_address'];?></label>
